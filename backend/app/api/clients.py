...
def create_client(payload: dict, owner_id: str = Depends(get_owner_id)):
    """
...
def update_client(client_id: int, payload: dict, owner_id: str = Depends(get_owner_id)):
    """
...
def delete_client(client_id: int, owner_id: str = Depends(get_owner_id)):
    """
